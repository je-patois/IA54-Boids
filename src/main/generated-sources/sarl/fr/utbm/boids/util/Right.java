...
public class Right extends Agent {
  @SyntheticMember
  ...
  @SyntheticMember
  public Right(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Right(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Right(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
