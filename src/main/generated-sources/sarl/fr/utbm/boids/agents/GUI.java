...
public class GUI extends Agent {
  ...
  @SyntheticMember
  private void $behaviorUnit$AgentLeft$4(final AgentLeft occurrence) {
    if (true) {
    }
  }
  ...
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$AgentLeft(final AgentLeft occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$AgentLeft$4(occurrence));
  }
