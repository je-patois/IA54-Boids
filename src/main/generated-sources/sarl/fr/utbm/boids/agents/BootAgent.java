...
import fr.utbm.boids.agents.GUI;
import fr.utbm.boids.agents.Scheduler;
import fr.utbm.boids.agents.Screen;
...
public class BootAgent extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1.info("The boot agent was started.");
  ...
  private void $behaviorUnit$IsStarted$2(final IsStarted occurrence) {
    ...
    if ((this.sons == 4)) {
      Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
      _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("All my lovely sons are born, I will let them live alone in peace.");
