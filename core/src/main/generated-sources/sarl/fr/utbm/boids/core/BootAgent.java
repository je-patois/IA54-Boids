...
import fr.utbm.boids.core.Environment;
import fr.utbm.boids.core.GUI;
import fr.utbm.boids.core.IsStarted;
import fr.utbm.boids.core.MakeTheFiestaBegin;
import fr.utbm.boids.core.Scheduler;
import fr.utbm.boids.core.Screen;
...
public class BootAgent extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_1.spawn(GUI.class);
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_2.spawn(Scheduler.class);
    Lifecycle _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_3 = this.$castSkill(Lifecycle.class, (this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE == null || this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE = this.$getSkill(Lifecycle.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE);
    _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER_3.spawn(Screen.class);
  }
  ...
  private void $behaviorUnit$IsStarted$2(final IsStarted occurrence) {
    ...
    if ((this.sons == 4)) {
      ...
      MakeTheFiestaBegin _makeTheFiestaBegin = new MakeTheFiestaBegin();
      _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_makeTheFiestaBegin);
      Lifecycle _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER = this.$castSkill(Lifecycle.class, (this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE == null || this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE = this.$getSkill(Lifecycle.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE);
